    ...
    <Box maxW="2000px" m={"auto"} backgroundColor={"#FFF5DF"}>
        ...
        >
          ...
          <Box>
            <Flex alignItems="center" my="0.5rem">
              <CheckBadge />
              <Text fontSize="1.5rem" color="#ffff" fontWeight="bold" px="1rem">
            ...
            <Flex alignItems="center" my="0.5rem">
              <CheckBadge />
              <Text fontSize="1.5rem" color="#ffff" fontWeight="bold" px="1rem">
                A team dedicated in bringing new customers to you
              </Text>
            </Flex>
            <Flex alignItems="center" my="0.5rem">
              <CheckBadge />
      ...
      <Box w="100%">
        ...
        <Flex
          ...
          px="5rem"
        >
          <Text fontSize="1.5rem" fontWeight={"extrabold"} color="#ffff">
            FOUNDER
          </Text>
          <Text fontSize="3rem" fontWeight={"extrabold"} color="#ffff">
            RICKY INGRAM
          </Text>
          <Text fontSize="1.25rem" fontWeight={"extrabold"} color="#ffff">
          ...
          >
            ...
            your business.Throughout the company’s growth, our team has
            maintained the same attention to detail with each client we work
            with. Every member of our growing team understands that our
            differentiating factor among other marketing agencies is the
      ...
      <Flex
        ...
        px="5rem"
      >
        <Text fontFamily={"dm-sans"} fontSize={"3rem"} fontWeight="extrabold">
          <span
            style={{
              color: "#EE6F19",
            }}
      ...
      <Flex w="100%" justifyContent={"center"} my="3rem">
        <Text
          ...
          textAlign={"center"}
        >
          We’ve worked with more than 100 companies since 2015 Check out some of
          the fantastic clients we have brought to the UK and International
          Markets.
        </Text>
      </Flex>
          ...
          <Box w="500px" my="20px" mx="20px" className="testimonial1">
            ...
            <Box className="statement2">
              ...
              <Text as="p" fontSize="md">
                ...
                keep growing the business further. Really great company to work
          ...
          <Box w="500px" my="20px" mx="20px" className="testimonial2">
            ...
            <Box className="statement2">
              ...
              <Text as="p" fontSize="md">
                ...
                we approached Ricky with my project that needed to be completely
                transformed. I have been working with the visualgroup.online for
                a few months since and Ricky has always been a man of his word,
                constantly deliveres quality and continues too. I highly
                recommend."
              </Text>
            </Box>
            <Flex justifyContent="center" alignItems="center" pt="20px">
        ...
        <Flex justifyContent={"center"} flexWrap="wrap" flexDirection={"row"}>
          <Box w="500px" mx="20px" my="20px" className="testimonial3">
            ...
            <Box className="statement2">
              ...
              <Text as="p">
                "Visual Group have been running my ads for the last 4 months and
                I can’t express enough how impressed I am with their results!
                They’ve increased my sales and allowed me to take my business to
                the level I wanted it to be at, but Wasn’t sure how to get
                there. They also helped me not just with a paid marketing plan
                but they also gave me advice on how to grow my business
                organically. Thank you so much! 2021 is going to be a big year!"
              </Text>
            </Box>
            <Flex justifyContent="center" alignItems="center" pt="20px">
              <Box>
          ...
          <Box w="500px" mx="20px" my="20px" className="testimonial4">
            ...
            <Box className="statement2">
              ...
              <Text as="p">
                ...
                marketing strategy, created 3 effective websites and have begun
                a marketing campaign that has generated leads, all within a 3
                month time period! Very quick and efficient at what they do.
                Very happy with the results! Would highly recommend them!"
              </Text>
            </Box>
            <Flex justifyContent="center" alignItems="center" pt="20px">
              <Box>
