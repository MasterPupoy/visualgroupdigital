...
export default function Sodelishus({ location }) {
 ...
 const allimages = bw.map(img => img)
    ...
    <Box className="main">
      ...
      <Box>
        ...
        >
          <Box>
           ...
           <Box
            ...
            py="20px"
          >
            <Badge>Promotional Company</Badge>
          </Box>
        </Flex>
        <Box
          w="95%"
        ...
        >
          ...
          >
            <h3>
              blackandwhitelondon.co.uk 
            </h3>
            <p>
             Black and White London, a leading UK Supplier of promotional items. We specialise in promotional business gifts, printed promotional items and branded corporate merchandise
            </p>
          </Box>
          {/* <Box
            px="160px"
