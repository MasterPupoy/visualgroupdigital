...
export default function Sodelishus({ location }) {
 ...
 const allimages = online.map(img => img)
    ...
    <Box className="main">
      ...
      <Box>
        ...
        >
          ...
          >
            <h3>
              onlinefitnessfreedom.com
            </h3>
            <p>
              Improve Their Marketing &amp; Branding To Help Them Maximise Their Clientele Potential.
            </p>
          </Box>
          {/* <Box
            px="160px"
