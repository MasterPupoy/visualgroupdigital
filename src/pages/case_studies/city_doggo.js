...
export default function Sodelishus({ location }) {
 ...
 const allimages = city.map(img => img)
      ...
      <Box>
        ...
        >
          ...
          <Box
                  ...
                  py="20px"
                >
                  <Badge>Pet Products Company</Badge>
                </Box>
        </Flex>
        <Box
          w="95%"
        ...
        >
          ...
          >
            ...
            <p>
              City Doggo introduces a return to nature for your metropolitan pet. Our first HERO product, the Oui Oui Patch is an eco-friendly, odour-free, real grass pet toilet for your flat or balcony.
            </p>
          </Box>
          {/* <Box
            px="160px"
