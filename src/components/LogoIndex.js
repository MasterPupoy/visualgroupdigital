...
export default function LogoIndex({ removedToggle }) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <img
            src={l10}
            alt="cleaningspecialistproviders.svg"
            className="logopng "
          />
      ...
      {removedToggle ? null : (
        ...
        >
          <Flex
            ...
            alignItems="center"
          >
            <Box alignSelf="center" display={div === 4 ? "none" : "flex"}>
              <button
              ...
              >
                <span>SEE MORE OF OUR CLIENTS</span>
              </button>
            </Box>
            <Box>
              <a className="reqCB" href="/contact">
                REQUEST A CALL BACK &gt;
              </a>
            </Box>
          </Flex>
